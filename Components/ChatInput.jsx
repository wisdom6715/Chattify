...
export default function ChatInput(){
    ...
    return <div className={style.inputConatiner}>
        ...
        <svg viewBox="0 0 24 24" width="30" preserveAspectRatio="xMidYMid meet" shapeRendering="crispEdges"><title>plus</title><path fill="currentColor" d="M19,13h-6v6h-2v-6H5v-2h6V5h2v6h6V13z"></path></svg>
